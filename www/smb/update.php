...
/* 1.10-t2 add simnum*/
	...
	if(!$rs || $rs[0] < 114){
		@$db->updatequery("update sim set month_remain_time=if(month_remain_time=-1, -1, month_remain_time*60)");
...
/* 1.17-t fixed bug of period time reset  */
/* 1.17-t3 add change remain logs  */
/* 1.17-t4 fixed bug of reset  */
/* 1.17-t5 fixed bug of smb_sheduler for period count  */
/* 1.17-t6 fixed bug of smb_sheduler for period count  */
/* 1.17-t7 fixed bug of smb_sheduler for period count  */
/* 1.17-t8 fixed bug of smb_sheduler for period count  */
/* 1.17.1 fixed bug of "all slot" in period  */
/* 1.17.2 fixed bug of disable sim  */
/* 1.18 fixed bug of upload  */
/* 1.19 fixed bug of upload  */
/* 1.20 month_remain_time use second  */
